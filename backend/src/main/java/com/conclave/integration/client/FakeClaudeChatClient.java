...
/**
 * Fake Claude ChatClient that implements the Spring AI ChatModel contract.
 * Simulates latency, chunked streaming, and token estimation.
 */
public class FakeClaudeChatClient implements ChatModel {

    private static final String MOCK_RESPONSE =
            "### Claude Code Critique\n" +
            "I reviewed the code implementation and found some areas for improvement:\n" +
            "- **Memory leak risk:** Ensure resource clean-up in websocket connections.\n" +
            "- **Thread safety:** Use ConcurrentHashMap instead of standard HashMap.";
