...
*   Invoked Llama 3 to summarize progress into a structured `WorkflowState` (draft & comments).
...
*   **Local Hardware Bounds:** Local inference speed is bounded by GPU VRAM and system memory.
