...
└── integration/
    └── adapter/
        ├── ModelAdapter.java           # Core adapter interface
...
- **Strict Translation Contracts:** The orchestrator must not have any compile-time dependency on model-specific prompt formats. All adapters must accept canonical JPA models and return normalized format representations (such as compiled prompt message lists).
...
### 2.1 Public Interface: `ModelAdapter`
...
### Task 4.1: Define ModelAdapter Interface and Adapter Types
- **Estimated Size:** S
- **Risk:** Low
- **Prerequisites:** Phase 02 Domain Models
- **Definition of Done:**
  - `ModelAdapter.java` created with clean JavaDocs defining its input/output parameters.
...
- **Definition of Done:**
  - `LlamaAdapter.java` implements `ModelAdapter`.
...
- **Prerequisites:** Task 4.1
- **Definition of Done:**
  - `MistralAdapter.java` implements `ModelAdapter`.
...
- **Prerequisites:** Task 4.1
- **Definition of Done:**
  - `GemmaAdapter.java` implements `ModelAdapter`.
...
- Create `Docs/Learning/03_Provider_Adapter_Pattern.md` (updated to Model Adapter Pattern) detailing:
...
- `integration: create ModelAdapter interface definition`
- `integration: implement LlamaAdapter translation logic and unit tests`
- `integration: implement MistralAdapter translation logic and unit tests`
- `integration: implement GemmaAdapter translation logic and unit tests`

### Suggested GitHub Issues
- **Issue 4.1:** Define Core ModelAdapter interface contracts. (Points: 1)
